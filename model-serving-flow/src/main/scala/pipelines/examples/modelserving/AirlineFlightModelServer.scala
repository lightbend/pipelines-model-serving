...
import pipelines.examples.data.{AirlineFlightRecord, AirlineFlightResult, ModelDescriptor, ModelType}
import pipelines.examples.modelserving.airlineflightmodel.{AirlineFlightDataRecord, AirlineFlightFactoryResolver}
...
final case object AirlineFlightModelServer extends AkkaStreamlet {
  ...
  override final def createLogic: RunnableGraphStreamletLogic = new RunnableGraphStreamletLogic() {
